...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//bottom info
		await loadBottomInfo({
			...
			wizards: {name:'wizards', text:'{elemidinfo-number} {elemidinfo-set} {elemidinfo-star} {elemidinfo-language}   {fontmplantin}\u2122 & \u00a9 {elemidinfo-year} Wizards of the Coast', x:0.0647, y:0.9614, width:0.8707, height:0.0167, oneLine:true, font:'gothammedium', size:0.0162, color:'white', align:'center', outlineWidth:0.003}
		});
