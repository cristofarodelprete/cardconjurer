...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//bottom info
		await loadBottomInfo({
			...
			copyright: {name:'copyright', text:'{elemidinfo-number} {elemidinfo-set} {elemidinfo-star} {elemidinfo-language}   {fontmplantin}{elemidinfo-copyright}', x:0.0647, y:0.9614, width:0.8707, height:0.0167, oneLine:true, font:'gothammedium', size:0.0162, color:'white', align:'center', outlineWidth:0.003}
		});
